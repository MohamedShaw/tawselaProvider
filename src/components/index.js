...
export { default as CustomBottomTabs } from './CustomBottomTabs';
export {
  default as DelivaryPlaceBottomTabs,
} from './DelivaryPlaceCustomBottomTabs';
...
export { default as AppErrorModal } from './appErrorModal/AppErrorModal';
...
export { default as ProviderGenderType } from './ProviderGenderType';
